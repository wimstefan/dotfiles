...
--- Taken from MariaSolos: https://github.com/MariaSolOs/dotfiles/blob/main/.config/nvim/lua/lightbulb.lua

local M = {}

local lb_name = 'mariasolos/lightbulb'
local lb_namespace = vim.api.nvim_create_namespace(lb_name)
local lb_icon = require('config.ui').icons.diagnostics[6]
