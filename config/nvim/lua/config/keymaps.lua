...
vim.keymap.set('n', 'K', function() ShowHelp() end, { desc = 'Search help pages for current word' })
...
vim.keymap.set('n', ',cd', [[<Cmd>color default<CR>]], { desc = 'Apply default colorscheme' })
vim.keymap.set('n', ',cl', [[<Cmd>color lunaperche<CR>]], { desc = 'Apply lunaperche colorscheme' })
vim.keymap.set('n', ',cq', [[<Cmd>color quiet<CR>]], { desc = 'Apply quiet colorscheme' })
